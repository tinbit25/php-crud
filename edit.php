...
if(isset($_POST['submit'])){
    ...
    $sql = "UPDATE `single_door` SET `material_name`='$material_name', `amount`='$amount', `remark`='$remark',
...
<div class="container">
<div class="text-center mb-4">Edit user information

<p class="text-muted">Click update after changing any information</p></div>
<?php
   $id=$_GET['id'];
   $sql = "SELECT * FROM `Material_registration`";
    $result=mysqli_query($conn,$sql);
